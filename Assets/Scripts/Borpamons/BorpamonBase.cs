...
public class BorpamonBase : ScriptableObject
{
    ...
    //typing
    [SerializeField] BorpamonType type1;
    [SerializeField] BorpamonType type2;
    ...
    public BorpamonType Type1
    {
        get { return type1; }
    }
    public BorpamonType Type2
    {
        get { return type2; }
    }
    public int MaxHp
...
public class TypeChart
{
    ...
    public static float GetEffectiveness(BorpamonType attackType, BorpamonType defenseType)
    {
        if(attackType == BorpamonType.None || defenseType == BorpamonType.None)
        {
            return 1;
        }
