...
public class Borpamon
{
    ...
    void CalculateStats()
    {
        ...
        Stats.Add(Stat.Attack, Mathf.FloorToInt((_base.Attack * Level) / 100f) + 5);
        Stats.Add(Stat.Defense, Mathf.FloorToInt((_base.Defense * Level) / 100f) + 5);
        Stats.Add(Stat.SpAttack, Mathf.FloorToInt((_base.SpAttack * Level) / 100f) + 5);
        Stats.Add(Stat.SpDefense, Mathf.FloorToInt((_base.SpDefense * Level) / 100f) + 5);
    ...
    int GetStat(Stat stat)
    {
        ...
        if (boost >= 0)
            ...
            statVal = Mathf.FloorToInt(statVal / boostValues[-1*boost]);
